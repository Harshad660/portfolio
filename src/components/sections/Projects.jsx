...
export const Projects = () => (
  <section id="projects" style={{ position: "relative", padding: "9rem 0", overflow: "hidden" }}>
    <Glow x="18%" y="32%" size={650} color="rgba(56,189,248,0.07)" />
    <Glow x="82%" y="68%" size={520} color="rgba(129,140,248,0.07)" />
    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 clamp(1.5rem, 5vw, 6rem)" }}>
      ...
      <FadeUp delay={0.1}>
        <h2 style={{ fontSize: "clamp(2.3rem, 4.5vw, 3.4rem)", fontWeight: 800, lineHeight: 1.12, marginBottom: "4rem", letterSpacing: "-0.03em" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 460px), 1fr))", gap: "1.6rem" }}>
        {PROJECTS.map((p, i) => (
          <FadeUp key={i} delay={i * 0.12}>
            <motion.div
              whileHover={{ y: -10, boxShadow: `0 30px 80px rgba(0,0,0,0.65), 0 0 0 1px ${p.tagColor}44` }}
              style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "1rem", marginBottom: "1.2rem" }}>
                <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#eef2f7", lineHeight: 1.4, flex: 1 }}>{p.title}</h3>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "0.4rem" }}>
                  ...
                  <span className="mono" style={{ fontSize: "0.58rem", color: "#64748b" }}>{p.period}</span>
                </div>
              </div>

              <p style={{ fontSize: "0.9rem", lineHeight: 1.9, color: "#9ca3af", marginBottom: "1.8rem" }}>{p.desc}</p>
              ...
              <motion.a
                ...
                style={{
                  ...
                  color: "#080c10", background: "linear-gradient(135deg,#38bdf8,#818cf8)",
